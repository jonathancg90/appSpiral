...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhotoCasting.realized'
        db.add_column(u'sp_photocasting', 'realized',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Casting.realized'
        db.add_column(u'sp_casting', 'realized',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhotoCasting.realized'
        db.delete_column(u'sp_photocasting', 'realized')

        # Deleting field 'Casting.realized'
        db.delete_column(u'sp_casting', 'realized')
