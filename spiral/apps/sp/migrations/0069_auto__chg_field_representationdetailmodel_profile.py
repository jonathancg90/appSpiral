...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RepresentationDetailModel.profile'
        db.alter_column(u'sp_representationdetailmodel', 'profile', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'RepresentationDetailModel.profile'
        db.alter_column(u'sp_representationdetailmodel', 'profile', self.gf('django.db.models.fields.CharField')(default=0, max_length=100))
