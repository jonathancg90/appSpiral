...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CriterionCategory.description'
        db.alter_column(u'sp_criterioncategory', 'description', self.gf('django.db.models.fields.CharField')(max_length=45))

        # Changing field 'Criterion.description'
        db.alter_column(u'sp_criterion', 'description', self.gf('django.db.models.fields.CharField')(max_length=45))

    def backwards(self, orm):

        # Changing field 'CriterionCategory.description'
        db.alter_column(u'sp_criterioncategory', 'description', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Criterion.description'
        db.alter_column(u'sp_criterion', 'description', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
