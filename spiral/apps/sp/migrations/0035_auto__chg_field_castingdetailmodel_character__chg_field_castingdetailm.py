...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CastingDetailModel.character'
        db.alter_column(u'sp_castingdetailmodel', 'character', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

        # Changing field 'CastingDetailModel.feature'
        db.alter_column(u'sp_castingdetailmodel', 'feature', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'ProjectDetailStaff.observations'
        db.alter_column(u'sp_projectdetailstaff', 'observations', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'CastingDetailModel.character'
        db.alter_column(u'sp_castingdetailmodel', 'character', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'CastingDetailModel.feature'
        db.alter_column(u'sp_castingdetailmodel', 'feature', self.gf('django.db.models.fields.CharField')(default=0, max_length=200))

        # Changing field 'ProjectDetailStaff.observations'
        db.alter_column(u'sp_projectdetailstaff', 'observations', self.gf('django.db.models.fields.TextField')(default=0))
