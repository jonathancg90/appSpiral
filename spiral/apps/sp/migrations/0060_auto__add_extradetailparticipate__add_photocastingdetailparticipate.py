...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExtraDetailParticipate'
        db.create_table(u'sp_extradetailparticipate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('detail_model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='extra_detail_participate_set', to=orm['sp.ExtrasDetailModel'])),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='extra_detail_participate_set', to=orm['sp.Model'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('sp', ['ExtraDetailParticipate'])

        # Adding model 'PhotoCastingDetailParticipate'
        db.create_table(u'sp_photocastingdetailparticipate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('detail_model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photo_casting_detail_participate_set', to=orm['sp.PhotoCastingDetailModel'])),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photo_casting_detail_participate_set', to=orm['sp.Model'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('sp', ['PhotoCastingDetailParticipate'])


    def backwards(self, orm):
        # Deleting model 'ExtraDetailParticipate'
        db.delete_table(u'sp_extradetailparticipate')

        # Deleting model 'PhotoCastingDetailParticipate'
        db.delete_table(u'sp_photocastingdetailparticipate')
