...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Model.model_code'
        db.alter_column(u'sp_model', 'model_code', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True))

    def backwards(self, orm):

        # Changing field 'Model.model_code'
        db.alter_column(u'sp_model', 'model_code', self.gf('django.db.models.fields.CharField')(max_length=45, unique=True))
