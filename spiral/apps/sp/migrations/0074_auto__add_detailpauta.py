...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DetailPauta'
        db.create_table(u'sp_detailpauta', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hour', self.gf('django.db.models.fields.TimeField')()),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='detail_pauta_set', null=True, to=orm['sp.Model'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('character', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
        ...
        db.send_create_signal('sp', ['DetailPauta'])


    def backwards(self, orm):
        # Deleting model 'DetailPauta'
        db.delete_table(u'sp_detailpauta')
