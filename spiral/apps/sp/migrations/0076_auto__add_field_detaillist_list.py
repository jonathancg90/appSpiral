...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetailList.list'
        db.add_column(u'sp_detaillist', 'list',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sp.List']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetailList.list'
        db.delete_column(u'sp_detaillist', 'list_id')
