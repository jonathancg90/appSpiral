...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Commercial.project_id'
        db.alter_column(u'sp_commercial', 'project_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sp.Project'], null=True))

    def backwards(self, orm):

        # Changing field 'Commercial.project_id'
        db.alter_column(u'sp_commercial', 'project_id_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['sp.Project']))
