...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PhotoCastingDetailModel'
        db.create_table(u'sp_photocastingdetailmodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('photo_casting', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photo_casting_detail_model_set', to=orm['sp.PhotoCasting'])),
            ...
            ('feature', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('character', self.gf('django.db.models.fields.SmallIntegerField')(default=1, null=True)),
            ('currency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='photo_casting_detail_model_set', null=True, to=orm['sp.Currency'])),
            ('budget', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('observations', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('sp', ['PhotoCastingDetailModel'])

        # Adding model 'TypePhotoCasting'
        db.create_table(u'sp_typephotocasting', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('sp', ['TypePhotoCasting'])

        # Adding model 'PhotoCasting'
        db.create_table(u'sp_photocasting', (
            ('project', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sp.Project'], unique=True, primary_key=True)),
            ('use_photo', self.gf('django.db.models.fields.DateField')(null=True)),
        ))
        db.send_create_signal('sp', ['PhotoCasting'])

        # Adding M2M table for field type_casting on 'PhotoCasting'
        db.create_table(u'sp_photocasting_type_casting', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('photocasting', models.ForeignKey(orm['sp.photocasting'], null=False)),
            ('typephotocasting', models.ForeignKey(orm['sp.typephotocasting'], null=False))
        ))
        db.create_unique(u'sp_photocasting_type_casting', ['photocasting_id', 'typephotocasting_id'])


    def backwards(self, orm):
        # Deleting model 'PhotoCastingDetailModel'
        db.delete_table(u'sp_photocastingdetailmodel')

        # Deleting model 'TypePhotoCasting'
        db.delete_table(u'sp_typephotocasting')

        # Deleting model 'PhotoCasting'
        db.delete_table(u'sp_photocasting')

        # Removing M2M table for field type_casting on 'PhotoCasting'
        db.delete_table('sp_photocasting_type_casting')
    ...
    models = {
        ...
        'sp.photocasting': {
            ...
            'project': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['sp.Project']", 'unique': 'True', 'primary_key': 'True'}),
            'type_casting': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['sp.TypePhotoCasting']", 'symmetrical': 'False'}),
            'use_photo': ('django.db.models.fields.DateField', [], {'null': 'True'})
        },
        ...
        'sp.representation': {
            ...
            'photo_use': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True'}),
            'project': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['sp.Project']", 'unique': 'True', 'primary_key': 'True'}),
            'type_event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'representation_set'", 'to': "orm['sp.TypeEvent']"})
        },
