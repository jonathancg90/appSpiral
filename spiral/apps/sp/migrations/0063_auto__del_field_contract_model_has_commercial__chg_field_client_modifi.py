...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contract.model_has_commercial'
        db.delete_column(u'sp_contract', 'model_has_commercial_id')


        # Changing field 'Client.modified'
        db.alter_column(u'sp_client', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):
        # Adding field 'Contract.model_has_commercial'
        db.add_column(u'sp_contract', 'model_has_commercial',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['sp.ModelHasCommercial']),
                      keep_default=False)


        # Changing field 'Client.modified'
        db.alter_column(u'sp_client', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
