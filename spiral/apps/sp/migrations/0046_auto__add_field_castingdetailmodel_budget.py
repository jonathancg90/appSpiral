...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CastingDetailModel.budget'
        db.add_column(u'sp_castingdetailmodel', 'budget',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CastingDetailModel.budget'
        db.delete_column(u'sp_castingdetailmodel', 'budget')
