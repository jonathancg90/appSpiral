...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Representation.photo_use'
        db.delete_column(u'sp_representation', 'photo_use')

        # Adding field 'Representation.ppi'
        db.add_column(u'sp_representation', 'ppi',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Representation.ppg'
        db.add_column(u'sp_representation', 'ppg',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Representation.photo_use'
        db.add_column(u'sp_representation', 'photo_use',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Deleting field 'Representation.ppi'
        db.delete_column(u'sp_representation', 'ppi')

        # Deleting field 'Representation.ppg'
        db.delete_column(u'sp_representation', 'ppg')
