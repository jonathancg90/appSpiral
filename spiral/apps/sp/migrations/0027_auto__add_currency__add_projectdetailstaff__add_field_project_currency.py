...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('sp', ['Currency'])

        # Adding model 'ProjectDetailStaff'
        db.create_table(u'sp_projectdetailstaff', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_detail_set', null=True, to=orm['sp.Project'])),
            ('role', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('employee', self.gf('django.db.models.fields.SmallIntegerField')()),
            ('budget', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2)),
            ('percentage', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=3)),
            ('observations', self.gf('django.db.models.fields.TextField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('sp', ['ProjectDetailStaff'])

        # Adding field 'Project.currency'
        db.add_column(u'sp_project', 'currency',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_set', null=True, to=orm['sp.Currency']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Currency'
        db.delete_table(u'sp_currency')

        # Deleting model 'ProjectDetailStaff'
        db.delete_table(u'sp_projectdetailstaff')

        # Deleting field 'Project.currency'
        db.delete_column(u'sp_project', 'currency_id')
