...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TypeClient'
        db.create_table(u'sp_typeclient', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ))
        db.send_create_signal('sp', ['TypeClient'])

        # Adding model 'Client'
        db.create_table(u'sp_client', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60)),
        ...
        db.send_create_signal('sp', ['Client'])

        # Adding M2M table for field type_client on 'Client'
        db.create_table(u'sp_client_type_client', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('client', models.ForeignKey(orm['sp.client'], null=False)),
            ('typeclient', models.ForeignKey(orm['sp.typeclient'], null=False))
        ))
        db.create_unique(u'sp_client_type_client', ['client_id', 'typeclient_id'])


    def backwards(self, orm):
        # Deleting model 'TypeClient'
        db.delete_table(u'sp_typeclient')

        # Deleting model 'Client'
        db.delete_table(u'sp_client')

        # Removing M2M table for field type_client on 'Client'
        db.delete_table('sp_client_type_client')
