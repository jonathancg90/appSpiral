...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ModelFeatureDetail.description'
        db.alter_column(u'sp_modelfeaturedetail', 'description', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'ModelFeatureDetail.description'
        db.alter_column(u'sp_modelfeaturedetail', 'description', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
