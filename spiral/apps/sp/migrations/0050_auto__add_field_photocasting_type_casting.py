...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhotoCasting.type_casting'
        db.add_column(u'sp_photocasting', 'type_casting',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='photo_casting_set', to=orm['sp.TypePhotoCasting']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'PhotoCasting.type_casting'
        db.delete_column(u'sp_photocasting', 'type_casting_id')
