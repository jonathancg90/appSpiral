...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UsePhotos'
        db.create_table(u'sp_usephotos', (
        ...
        db.send_create_signal('sp', ['UsePhotos'])

        # Deleting field 'PhotoCasting.use_photo'
        db.delete_column(u'sp_photocasting', 'use_photo')

        # Adding M2M table for field use_photo on 'PhotoCasting'
        db.create_table(u'sp_photocasting_use_photo', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('photocasting', models.ForeignKey(orm['sp.photocasting'], null=False)),
            ('usephotos', models.ForeignKey(orm['sp.usephotos'], null=False))
        ))
        db.create_unique(u'sp_photocasting_use_photo', ['photocasting_id', 'usephotos_id'])


    def backwards(self, orm):
        # Deleting model 'UsePhotos'
        db.delete_table(u'sp_usephotos')

        # Adding field 'PhotoCasting.use_photo'
        db.add_column(u'sp_photocasting', 'use_photo',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Removing M2M table for field use_photo on 'PhotoCasting'
        db.delete_table('sp_photocasting_use_photo')
