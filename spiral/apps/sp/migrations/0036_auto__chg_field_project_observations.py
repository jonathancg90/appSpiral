...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.observations'
        db.alter_column(u'sp_project', 'observations', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Project.observations'
        db.alter_column(u'sp_project', 'observations', self.gf('django.db.models.fields.TextField')(default=0))
