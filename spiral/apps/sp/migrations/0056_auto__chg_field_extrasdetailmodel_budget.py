...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExtrasDetailModel.budget'
        db.alter_column(u'sp_extrasdetailmodel', 'budget', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'ExtrasDetailModel.budget'
        db.alter_column(u'sp_extrasdetailmodel', 'budget', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2))
