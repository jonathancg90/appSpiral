...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Payment.client'
        db.alter_column(u'sp_payment', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['sp.Client']))

    def backwards(self, orm):

        # Changing field 'Payment.client'
        db.alter_column(u'sp_payment', 'client_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['sp.Client']))
