...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CastingDetailModel.budget'
        db.alter_column(u'sp_castingdetailmodel', 'budget', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'CastingDetailModel.budget'
        db.alter_column(u'sp_castingdetailmodel', 'budget', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2))
