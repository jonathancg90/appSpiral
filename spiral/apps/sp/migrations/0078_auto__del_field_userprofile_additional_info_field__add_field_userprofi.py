...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.additional_info_field'
        db.delete_column(u'sp_userprofile', 'additional_info_field')

        # Adding field 'UserProfile.cod_emp'
        db.add_column(u'sp_userprofile', 'cod_emp',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.additional_info_field'
        db.add_column(u'sp_userprofile', 'additional_info_field',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=50),
                      keep_default=False)

        # Deleting field 'UserProfile.cod_emp'
        db.delete_column(u'sp_userprofile', 'cod_emp')
