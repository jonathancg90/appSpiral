...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Model.phone_fixed'
        db.alter_column(u'sp_model', 'phone_fixed', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Model.name_complete'
        db.alter_column(u'sp_model', 'name_complete', self.gf('django.db.models.fields.CharField')(max_length=65))

        # Changing field 'Model.phone_mobil'
        db.alter_column(u'sp_model', 'phone_mobil', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

    def backwards(self, orm):

        # Changing field 'Model.phone_fixed'
        db.alter_column(u'sp_model', 'phone_fixed', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Model.name_complete'
        db.alter_column(u'sp_model', 'name_complete', self.gf('django.db.models.fields.CharField')(max_length=45))

        # Changing field 'Model.phone_mobil'
        db.alter_column(u'sp_model', 'phone_mobil', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
