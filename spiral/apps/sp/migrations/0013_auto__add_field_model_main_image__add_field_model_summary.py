...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Model.main_image'
        db.add_column(u'sp_model', 'main_image',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Model.summary'
        db.add_column(u'sp_model', 'summary',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Model.main_image'
        db.delete_column(u'sp_model', 'main_image')

        # Deleting field 'Model.summary'
        db.delete_column(u'sp_model', 'summary')
    ...
    models = {
        ...
        'sp.model': {
            ...
            'main_image': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
