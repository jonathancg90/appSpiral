...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ModelFeatureDetail'
        db.create_table(u'sp_modelfeaturedetail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='model_feature_detail_set', to=orm['sp.Model'])),
            ('feature_value', self.gf('django.db.models.fields.related.ForeignKey')(related_name='model_feature_detail_set', to=orm['sp.FeatureValue'])),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('sp', ['ModelFeatureDetail'])


    def backwards(self, orm):
        # Deleting model 'ModelFeatureDetail'
        db.delete_table(u'sp_modelfeaturedetail')
