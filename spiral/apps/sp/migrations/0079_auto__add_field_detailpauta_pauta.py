...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetailPauta.pauta'
        db.add_column(u'sp_detailpauta', 'pauta',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='detail_pauta_set', to=orm['sp.Pauta']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetailPauta.pauta'
        db.delete_column(u'sp_detailpauta', 'pauta_id')
