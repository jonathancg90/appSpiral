...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sp_mediafeature', (
        ...
        db.send_create_signal('sp', ['MediaFeature'])

        # Adding model 'MediaFeatureValue'
        db.create_table(u'sp_mediafeaturevalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=70)),
            ('media_feature', self.gf('django.db.models.fields.related.ForeignKey')(related_name='media_feature_value_set', to=orm['sp.MediaFeature'])),
            ('status', self.gf('django.db.models.fields.SmallIntegerField')(default=1)),
        ))
        db.send_create_signal('sp', ['MediaFeatureValue'])

        # Adding model 'PictureDetailFeature'
        db.create_table(u'sp_picturedetailfeature', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('picture', self.gf('django.db.models.fields.related.ForeignKey')(related_name='picture_detail_feature_set', to=orm['fileupload.Picture'])),
            ('feature_value', self.gf('django.db.models.fields.related.ForeignKey')(related_name='picture_detail_feature_set', to=orm['sp.MediaFeatureValue'])),
        ))
        db.send_create_signal('sp', ['PictureDetailFeature'])


    def backwards(self, orm):
        # Deleting model 'MediaFeature'
        db.delete_table(u'sp_mediafeature')

        # Deleting model 'MediaFeatureValue'
        db.delete_table(u'sp_mediafeaturevalue')

        # Deleting model 'PictureDetailFeature'
        db.delete_table(u'sp_picturedetailfeature')
