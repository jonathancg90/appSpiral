...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CastingDetailParticipate'
        db.create_table(u'sp_castingdetailparticipate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('detail_model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='casting_detail_participate_set', to=orm['sp.CastingDetailModel'])),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='casting_detail_participate_set', to=orm['sp.Model'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('sp', ['CastingDetailParticipate'])


    def backwards(self, orm):
        # Deleting model 'CastingDetailParticipate'
        db.delete_table(u'sp_castingdetailparticipate')
