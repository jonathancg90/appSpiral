...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DutyDetail'
        db.create_table(u'sp_dutydetail', (
            ('project', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sp.Project'], unique=True, primary_key=True)),
            ('type_contract', self.gf('django.db.models.fields.related.ForeignKey')(related_name='duty_detail_set', null=True, to=orm['sp.TypeContract'])),
            ('duration_month', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('sp', ['DutyDetail'])

        # Adding M2M table for field broadcast on 'DutyDetail'
        db.create_table(u'sp_dutydetail_broadcast', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dutydetail', models.ForeignKey(orm['sp.dutydetail'], null=False)),
            ('broadcast', models.ForeignKey(orm['sp.broadcast'], null=False))
        ))
        db.create_unique(u'sp_dutydetail_broadcast', ['dutydetail_id', 'broadcast_id'])

        # Adding M2M table for field country on 'DutyDetail'
        db.create_table(u'sp_dutydetail_country', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dutydetail', models.ForeignKey(orm['sp.dutydetail'], null=False)),
            ('country', models.ForeignKey(orm['sp.country'], null=False))
        ))
        db.create_unique(u'sp_dutydetail_country', ['dutydetail_id', 'country_id'])


    def backwards(self, orm):
        # Deleting model 'DutyDetail'
        db.delete_table(u'sp_dutydetail')

        # Removing M2M table for field broadcast on 'DutyDetail'
        db.delete_table('sp_dutydetail_broadcast')

        # Removing M2M table for field country on 'DutyDetail'
        db.delete_table('sp_dutydetail_country')
