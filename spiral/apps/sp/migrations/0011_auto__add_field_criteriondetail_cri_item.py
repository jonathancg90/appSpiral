...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CriterionDetail.cri_item'
        db.add_column(u'sp_criteriondetail', 'cri_item',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CriterionDetail.cri_item'
        db.delete_column(u'sp_criteriondetail', 'cri_item')
