...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TypeContract.modified'
        db.alter_column(u'sp_typecontract', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'PhotoCastingDetailModel.modified'
        db.alter_column(u'sp_photocastingdetailmodel', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'TypePhotoCasting.modified'
        db.alter_column(u'sp_typephotocasting', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Feature.modified'
        db.alter_column(u'sp_feature', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ModelFeatureDetail.modified'
        db.alter_column(u'sp_modelfeaturedetail', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Currency.modified'
        db.alter_column(u'sp_currency', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Contract.modified'
        db.alter_column(u'sp_contract', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'CastingDetailParticipate.modified'
        db.alter_column(u'sp_castingdetailparticipate', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'TypeEvent.modified'
        db.alter_column(u'sp_typeevent', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'CastingDetailModel.modified'
        db.alter_column(u'sp_castingdetailmodel', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'RepresentationDetailModel.modified'
        db.alter_column(u'sp_representationdetailmodel', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Country.modified'
        db.alter_column(u'sp_country', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ExtrasDetailModel.modified'
        db.alter_column(u'sp_extrasdetailmodel', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ModelHasCommercial.modified'
        db.alter_column(u'sp_modelhascommercial', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'City.modified'
        db.alter_column(u'sp_city', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Project.modified'
        db.alter_column(u'sp_project', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'FeatureValue.modified'
        db.alter_column(u'sp_featurevalue', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'UsePhotos.modified'
        db.alter_column(u'sp_usephotos', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Entry.modified'
        db.alter_column(u'sp_entry', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Model.modified'
        db.alter_column(u'sp_model', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Studio.modified'
        db.alter_column(u'sp_studio', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Brand.modified'
        db.alter_column(u'sp_brand', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Commercial.modified'
        db.alter_column(u'sp_commercial', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ProjectDetailStaff.modified'
        db.alter_column(u'sp_projectdetailstaff', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'ExtraDetailParticipate.modified'
        db.alter_column(u'sp_extradetailparticipate', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'TypeCasting.modified'
        db.alter_column(u'sp_typecasting', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'TypeContract.modified'
        db.alter_column(u'sp_typecontract', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'PhotoCastingDetailModel.modified'
        db.alter_column(u'sp_photocastingdetailmodel', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'TypePhotoCasting.modified'
        db.alter_column(u'sp_typephotocasting', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Feature.modified'
        db.alter_column(u'sp_feature', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ModelFeatureDetail.modified'
        db.alter_column(u'sp_modelfeaturedetail', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Currency.modified'
        db.alter_column(u'sp_currency', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Contract.modified'
        db.alter_column(u'sp_contract', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'CastingDetailParticipate.modified'
        db.alter_column(u'sp_castingdetailparticipate', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'TypeEvent.modified'
        db.alter_column(u'sp_typeevent', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'CastingDetailModel.modified'
        db.alter_column(u'sp_castingdetailmodel', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'RepresentationDetailModel.modified'
        db.alter_column(u'sp_representationdetailmodel', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Country.modified'
        db.alter_column(u'sp_country', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ExtrasDetailModel.modified'
        db.alter_column(u'sp_extrasdetailmodel', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ModelHasCommercial.modified'
        db.alter_column(u'sp_modelhascommercial', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'City.modified'
        db.alter_column(u'sp_city', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Project.modified'
        db.alter_column(u'sp_project', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'FeatureValue.modified'
        db.alter_column(u'sp_featurevalue', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'UsePhotos.modified'
        db.alter_column(u'sp_usephotos', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Entry.modified'
        db.alter_column(u'sp_entry', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Model.modified'
        db.alter_column(u'sp_model', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Studio.modified'
        db.alter_column(u'sp_studio', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Brand.modified'
        db.alter_column(u'sp_brand', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Commercial.modified'
        db.alter_column(u'sp_commercial', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ProjectDetailStaff.modified'
        db.alter_column(u'sp_projectdetailstaff', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'ExtraDetailParticipate.modified'
        db.alter_column(u'sp_extradetailparticipate', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'TypeCasting.modified'
        db.alter_column(u'sp_typecasting', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
