...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field country on 'Contract'
        db.create_table(u'sp_contract_country', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contract', models.ForeignKey(orm['sp.contract'], null=False)),
            ('country', models.ForeignKey(orm['sp.country'], null=False))
        ))
        db.create_unique(u'sp_contract_country', ['contract_id', 'country_id'])


    def backwards(self, orm):
        # Adding model 'CountryHasContract'
        db.create_table(u'sp_countryhascontract', (
            ('country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sp.Country'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contract', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sp.Contract'])),
        ))
        ...
        # Removing M2M table for field country on 'Contract'
        db.delete_table('sp_contract_country')
