...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RepresentationDetailModel.representation'
        db.add_column(u'sp_representationdetailmodel', 'representation',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='representation_detail_model_set', to=orm['sp.Representation']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RepresentationDetailModel.representation'
        db.delete_column(u'sp_representationdetailmodel', 'representation_id')
