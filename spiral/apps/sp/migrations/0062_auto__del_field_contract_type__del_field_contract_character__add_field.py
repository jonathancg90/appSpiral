...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contract.type'
        db.delete_column(u'sp_contract', 'type')

        # Deleting field 'Contract.character'
        db.delete_column(u'sp_contract', 'character')

        # Adding field 'Contract.start_contract'
        db.add_column(u'sp_contract', 'start_contract',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'Contract.end_contract'
        db.add_column(u'sp_contract', 'end_contract',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 8, 6, 0, 0)),
                      keep_default=False)

        # Adding field 'Contract.type_contract'
        db.add_column(u'sp_contract', 'type_contract',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='contract_set', null=True, to=orm['sp.TypeContract']),
                      keep_default=False)

        # Adding field 'Contract.duration_month'
        db.add_column(u'sp_contract', 'duration_month',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding M2M table for field broadcast on 'Contract'
        db.create_table(u'sp_contract_broadcast', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contract', models.ForeignKey(orm['sp.contract'], null=False)),
            ('broadcast', models.ForeignKey(orm['sp.broadcast'], null=False))
        ))
        db.create_unique(u'sp_contract_broadcast', ['contract_id', 'broadcast_id'])


    def backwards(self, orm):
        # Adding field 'Contract.type'
        db.add_column(u'sp_contract', 'type',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Contract.character'
        db.add_column(u'sp_contract', 'character',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=45),
                      keep_default=False)

        # Deleting field 'Contract.start_contract'
        db.delete_column(u'sp_contract', 'start_contract')

        # Deleting field 'Contract.end_contract'
        db.delete_column(u'sp_contract', 'end_contract')

        # Deleting field 'Contract.type_contract'
        db.delete_column(u'sp_contract', 'type_contract_id')

        # Deleting field 'Contract.duration_month'
        db.delete_column(u'sp_contract', 'duration_month')

        # Removing M2M table for field broadcast on 'Contract'
        db.delete_table('sp_contract_broadcast')
