...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sp_casting', (
            ('project', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sp.Project'], unique=True, primary_key=True)),
            ('ppi', self.gf('django.db.models.fields.DateField')(null=True)),
            ('ppg', self.gf('django.db.models.fields.DateField')(null=True)),
            ('type_casting', self.gf('django.db.models.fields.related.ForeignKey')(related_name='casting_set', to=orm['sp.TypeCasting'])),
        ))
        db.send_create_signal('sp', ['Casting'])

        # Adding model 'TypeCasting'
        db.create_table(u'sp_typecasting', (
        ...
        db.send_create_signal('sp', ['TypeCasting'])


    def backwards(self, orm):
        # Deleting model 'Casting'
        db.delete_table(u'sp_casting')

        # Deleting model 'TypeCasting'
        db.delete_table(u'sp_typecasting')
