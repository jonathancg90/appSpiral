...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TypeContract'
        db.create_table(u'sp_typecontract', (
        ...
        db.send_create_signal('sp', ['TypeContract'])

        # Adding model 'Broadcast'
        db.create_table(u'sp_broadcast', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=70)),
            ('status', self.gf('django.db.models.fields.SmallIntegerField')(default=1)),
        ))
        db.send_create_signal('sp', ['Broadcast'])


    def backwards(self, orm):
        # Deleting model 'TypeContract'
        db.delete_table(u'sp_typecontract')

        # Deleting model 'Broadcast'
        db.delete_table(u'sp_broadcast')
