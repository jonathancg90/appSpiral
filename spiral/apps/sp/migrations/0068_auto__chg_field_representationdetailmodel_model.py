...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RepresentationDetailModel.model'
        db.alter_column(u'sp_representationdetailmodel', 'model_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['sp.Model']))

    def backwards(self, orm):

        # Changing field 'RepresentationDetailModel.model'
        db.alter_column(u'sp_representationdetailmodel', 'model_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['sp.Model']))
