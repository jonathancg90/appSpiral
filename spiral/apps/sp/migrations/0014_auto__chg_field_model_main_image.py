...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Model.main_image'
        db.alter_column(u'sp_model', 'main_image', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Model.main_image'
        db.alter_column(u'sp_model', 'main_image', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
