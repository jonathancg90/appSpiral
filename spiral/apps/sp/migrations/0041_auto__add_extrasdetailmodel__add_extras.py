...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExtrasDetailModel'
        db.create_table(u'sp_extrasdetailmodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('extras', self.gf('django.db.models.fields.related.ForeignKey')(related_name='extras_detail_model_set', to=orm['sp.Extras'])),
            ...
            ('currency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='extra_detail_set', null=True, to=orm['sp.Currency'])),
        ...
        db.send_create_signal('sp', ['ExtrasDetailModel'])

        # Adding model 'Extras'
        db.create_table(u'sp_extras', (
            ('project', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sp.Project'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('sp', ['Extras'])


    def backwards(self, orm):
        # Deleting model 'ExtrasDetailModel'
        db.delete_table(u'sp_extrasdetailmodel')

        # Deleting model 'Extras'
        db.delete_table(u'sp_extras')
