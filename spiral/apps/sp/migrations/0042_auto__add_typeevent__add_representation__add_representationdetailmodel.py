...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TypeEvent'
        db.create_table(u'sp_typeevent', (
        ...
        db.send_create_signal('sp', ['TypeEvent'])

        # Adding model 'Representation'
        db.create_table(u'sp_representation', (
            ('project', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sp.Project'], unique=True, primary_key=True)),
            ('photo_use', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('type_event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='representation_set', to=orm['sp.TypeEvent'])),
        ))
        db.send_create_signal('sp', ['Representation'])

        # Adding model 'RepresentationDetailModel'
        db.create_table(u'sp_representationdetailmodel', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='representation_set', to=orm['sp.Model'])),
            ('character', self.gf('django.db.models.fields.SmallIntegerField')(default=2)),
            ('currency', self.gf('django.db.models.fields.related.ForeignKey')(related_name='representation_detail_model_set', null=True, to=orm['sp.Currency'])),
            ('budget', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('budget_cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2)),
            ('schedule', self.gf('django.db.models.fields.TextField')(null=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('sp', ['RepresentationDetailModel'])


    def backwards(self, orm):
        # Deleting model 'TypeEvent'
        db.delete_table(u'sp_typeevent')

        # Deleting model 'Representation'
        db.delete_table(u'sp_representation')

        # Deleting model 'RepresentationDetailModel'
        db.delete_table(u'sp_representationdetailmodel')
    ...
    models = {
        ...
        'sp.representationdetailmodel': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'model': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'representation_set'", 'to': "orm['sp.Model']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'profile': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'schedule': ('django.db.models.fields.TextField', [], {'null': 'True'})
        },
