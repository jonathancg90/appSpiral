...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectClientDetail'
        db.create_table(u'sp_projectclientdetail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sp.Project'])),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sp.Client'])),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sp.TypeClient'])),
        ))
        db.send_create_signal('sp', ['ProjectClientDetail'])

        # Removing M2M table for field client on 'Project'
        db.delete_table('sp_project_client')


    def backwards(self, orm):
        # Deleting model 'ProjectClientDetail'
        db.delete_table(u'sp_projectclientdetail')

        # Adding M2M table for field client on 'Project'
        db.create_table(u'sp_project_client', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['sp.project'], null=False)),
            ('client', models.ForeignKey(orm['sp.client'], null=False))
        ))
        db.create_unique(u'sp_project_client', ['project_id', 'client_id'])
