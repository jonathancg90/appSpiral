...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'sp_client', 'address', self.gf('django.db.models.fields.CharField')(max_length=70, null=True))

    def backwards(self, orm):

        # Changing field 'Client.address'
        db.alter_column(u'sp_client', 'address', self.gf('django.db.models.fields.CharField')(default=0, max_length=70))
