...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Client', fields ['ruc']
        db.create_unique(u'sp_client', ['ruc'])


    def backwards(self, orm):
        # Removing unique constraint on 'Client', fields ['ruc']
        db.delete_unique(u'sp_client', ['ruc'])
