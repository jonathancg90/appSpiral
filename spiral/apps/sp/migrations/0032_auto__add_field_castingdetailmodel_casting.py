...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CastingDetailModel.casting'
        db.add_column(u'sp_castingdetailmodel', 'casting',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='casting_detail_model_set', to=orm['sp.Casting']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CastingDetailModel.casting'
        db.delete_column(u'sp_castingdetailmodel', 'casting_id')
