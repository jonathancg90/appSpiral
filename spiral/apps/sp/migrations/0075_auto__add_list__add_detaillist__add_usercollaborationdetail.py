...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'List'
        db.create_table(u'sp_list', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=45)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='list_set', null=True, to=orm['sp.Project'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('status', self.gf('django.db.models.fields.SmallIntegerField')(default=1)),
        ))
        db.send_create_signal('sp', ['List'])

        # Adding model 'DetailList'
        db.create_table(u'sp_detaillist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='detail_list_set', null=True, to=orm['sp.Model'])),
            ('name_complete', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('DNI', self.gf('django.db.models.fields.CharField')(max_length=8, null=True)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('observation', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('sp', ['DetailList'])

        # Adding model 'UserCollaborationDetail'
        db.create_table(u'sp_usercollaborationdetail', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sp.List'])),
            ('is_owner', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('sp', ['UserCollaborationDetail'])


    def backwards(self, orm):
        # Deleting model 'List'
        db.delete_table(u'sp_list')

        # Deleting model 'DetailList'
        db.delete_table(u'sp_detaillist')

        # Deleting model 'UserCollaborationDetail'
        db.delete_table(u'sp_usercollaborationdetail')
