...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectDetailDeliveries'
        db.create_table(u'sp_projectdetaildeliveries', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='project_detail_deliveries_set', null=True, to=orm['sp.Project'])),
            ('delivery_date', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('sp', ['ProjectDetailDeliveries'])


    def backwards(self, orm):
        # Deleting model 'ProjectDetailDeliveries'
        db.delete_table(u'sp_projectdetaildeliveries')
