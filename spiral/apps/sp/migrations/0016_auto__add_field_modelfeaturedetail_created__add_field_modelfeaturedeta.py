...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModelFeatureDetail.created'
        db.add_column(u'sp_modelfeaturedetail', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 5, 7, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ModelFeatureDetail.modified'
        db.add_column(u'sp_modelfeaturedetail', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 5, 7, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModelFeatureDetail.created'
        db.delete_column(u'sp_modelfeaturedetail', 'created')

        # Deleting field 'ModelFeatureDetail.modified'
        db.delete_column(u'sp_modelfeaturedetail', 'modified')
    ...
    models = {
        ...
        'sp.model': {
            ...
            'main_image': ('django.db.models.fields.CharField', [], {'default': "'static/img/default.png'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
