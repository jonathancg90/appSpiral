...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'sp_payment', (
            ('project', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sp.Project'], unique=True, primary_key=True)),
            ('conditions', self.gf('django.db.models.fields.TextField')(null=True)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(related_name='casting_set', to=orm['sp.Client'])),
        ))
        db.send_create_signal('sp', ['Payment'])


    def backwards(self, orm):
        # Deleting model 'Payment'
        db.delete_table(u'sp_payment')
