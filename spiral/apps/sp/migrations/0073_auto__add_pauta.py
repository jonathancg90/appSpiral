...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Pauta'
        db.create_table(u'sp_pauta', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pauta_set', to=orm['sp.Project'])),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('status', self.gf('django.db.models.fields.SmallIntegerField')(default=1)),
        ))
        db.send_create_signal('sp', ['Pauta'])

        # Adding M2M table for field users on 'Pauta'
        db.create_table(u'sp_pauta_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pauta', models.ForeignKey(orm['sp.pauta'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(u'sp_pauta_users', ['pauta_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'Pauta'
        db.delete_table(u'sp_pauta')

        # Removing M2M table for field users on 'Pauta'
        db.delete_table('sp_pauta_users')
