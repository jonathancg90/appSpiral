...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Model.cant_casting'
        db.add_column(u'sp_model', 'cant_casting',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Model.cant_extra'
        db.add_column(u'sp_model', 'cant_extra',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Model.cant_casting'
        db.delete_column(u'sp_model', 'cant_casting')

        # Deleting field 'Model.cant_extra'
        db.delete_column(u'sp_model', 'cant_extra')
