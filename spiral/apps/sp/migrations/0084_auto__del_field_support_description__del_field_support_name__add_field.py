...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Support.description'
        db.delete_column(u'sp_support', 'description')

        # Deleting field 'Support.name'
        db.delete_column(u'sp_support', 'name')

        # Adding field 'Support.text'
        db.add_column(u'sp_support', 'text',
                      self.gf('django.db.models.fields.TextField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Support.description'
        db.add_column(u'sp_support', 'description',
                      self.gf('django.db.models.fields.TextField')(default=0),
                      keep_default=False)

        # Adding field 'Support.name'
        db.add_column(u'sp_support', 'name',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=45),
                      keep_default=False)

        # Deleting field 'Support.text'
        db.delete_column(u'sp_support', 'text')
