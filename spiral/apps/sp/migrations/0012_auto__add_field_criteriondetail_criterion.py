...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CriterionDetail.criterion'
        db.add_column(u'sp_criteriondetail', 'criterion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='criterion_detail_set', to=orm['sp.Criterion']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CriterionDetail.criterion'
        db.delete_column(u'sp_criteriondetail', 'criterion_id')
