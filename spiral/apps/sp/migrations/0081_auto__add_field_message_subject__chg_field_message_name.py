...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'sp_message', 'subject',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)


        # Changing field 'Message.name'
        db.alter_column(u'sp_message', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'Message.subject'
        db.delete_column(u'sp_message', 'subject')


        # Changing field 'Message.name'
        db.alter_column(u'sp_message', 'name', self.gf('django.db.models.fields.CharField')(max_length=45))
