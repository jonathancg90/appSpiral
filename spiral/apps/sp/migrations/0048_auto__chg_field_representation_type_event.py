...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Representation.type_event'
        db.alter_column(u'sp_representation', 'type_event_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['sp.TypeEvent']))

    def backwards(self, orm):

        # Changing field 'Representation.type_event'
        db.alter_column(u'sp_representation', 'type_event_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['sp.TypeEvent']))
