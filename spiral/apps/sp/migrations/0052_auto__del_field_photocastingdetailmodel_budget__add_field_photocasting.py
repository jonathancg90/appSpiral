...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PhotoCastingDetailModel.budget'
        db.delete_column(u'sp_photocastingdetailmodel', 'budget')

        # Adding field 'PhotoCastingDetailModel.budget_cost'
        db.add_column(u'sp_photocastingdetailmodel', 'budget_cost',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PhotoCastingDetailModel.budget'
        db.add_column(u'sp_photocastingdetailmodel', 'budget',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2),
                      keep_default=False)

        # Deleting field 'PhotoCastingDetailModel.budget_cost'
        db.delete_column(u'sp_photocastingdetailmodel', 'budget_cost')
