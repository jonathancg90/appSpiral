...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Picture.taken_date'
        db.add_column(u'fileupload_picture', 'taken_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Picture.taken_date'
        db.delete_column(u'fileupload_picture', 'taken_date')
